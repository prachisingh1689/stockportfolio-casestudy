...
public class SearchStockAction extends ActionSupport {
	...
	/** The link controller. */
	private SearchStockManager linkController;
	...
	/**
	 * Instantiates a new search stock action.
	 */
	public SearchStockAction() {

		linkController = new SearchStockManager();
	}

	/**
	 * Browse_all stock.. this method is used to initiate searching process of
	...
	public String Browse_allStock() {
		this.stockList = linkController.all_stocks();
		return "success";
	}
	...
	public String execute() {
		...
		this.stockList = linkController.dosearch(getSymbol());
