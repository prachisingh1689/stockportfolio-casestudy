...
public class Forgot_passwordActionTest extends StrutsTestCase {
	public void testExecute() throws Exception {
		...
		/*
		 * request.setParameter("email", "prachi.singh1689@gmail.com");//invalid
		 * emailid ActionProxy proxy1=getActionProxy("/forgot_password");
