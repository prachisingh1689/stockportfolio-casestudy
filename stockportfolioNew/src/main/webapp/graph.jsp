...
<script language="javascript" type="text/javascript">
	...
	if (startdate == "" && enddate == "") {
		...
		window.location = "chart.action?stockId=" + id + "&&startDate="
	...
	function mypromptBox(id) {
		...
		window.location = "chart.action?stockId=" + id + "&&startDate=" + year
	...
	function setInterval(id) {
		...
		window.location ="chart.action?stockId="+id+"&&startDate="+startdate+" 00:00:00&&endDate="+enddate+" 23:59:59";
		}else if(startdate == "" ){
	...
	<s:if test="%{#session['user_id']!= null}">
		...
		<div id="templatemo_container">
			...
			<div id="templatemo_banner_bar">
				...
				<p>(View past performance of stocks)<br />(Select duration to view charts)</p>
			...
			<div id="templatemo_menu">
				<ul>
					...
					<li><a href="BROWSE_ALL">Add</a>
					</li>
					<li><a href="BROWSE_ALL">Search</a>
					</li>
